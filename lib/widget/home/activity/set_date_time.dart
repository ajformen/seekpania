...
import 'package:challenge_seekpania/widget/home/dummy/set_location_notes.dart';
...
class SetDateTime extends StatefulWidget {
  ...
  SetDateTime({this.searchID, this.interestName, this.searchType, this.caption, this.companionType, this.participants});


  @override
  _SetDateTimeState createState() => _SetDateTimeState();
}
